...
{
    constexpr PinName MOTOR_BR_DIR = PA_9; // モータ1の方向
    constexpr PinName MOTOR_FR_DIR = PB_2; // モータ2の方向
    constexpr PinName MOTOR_FL_DIR = PB_1; // モータ3の方向
    constexpr PinName MOTOR_BL_DIR = PA_12; // モータ4の方向
    #if USE_PROPELLER
...
{
    constexpr PinName MOTOR_BR_PWM = PB_13; // モータ1のPWM
    constexpr PinName MOTOR_FR_PWM = PB_14; // モータ2のPWM
    constexpr PinName MOTOR_FL_PWM = PB_15; // モータ3のPWM
    constexpr PinName MOTOR_BL_PWM = PA_11; // モータ4のPWM
    #if USE_PROPELLER
...
namespace DigitalInPins
{
    ...
    constexpr PinName ENCODER_BL_B = PB_7; // エンコーダ2のB相
    constexpr PinName MEASURING_ENCODER1_B = PC_3; // エンコーダ3のB相×
    constexpr PinName ENCODER_BR_B = PA_4; // エンコーダ4のB相
    constexpr PinName ENCODER_FR_B = PA_0; // 測定輪エンコーダ1のB相
...
namespace InterruptInPins
{
    ...
    constexpr PinName ENCODER_BL_A = PC_2; // エンコーダ2のA相
    constexpr PinName MEASURING_ENCODER1_A = PA_3; // エンコーダ3のA相×
    constexpr PinName ENCODER_BR_A = PB_0; // エンコーダ4のA相右前
    constexpr PinName ENCODER_FR_A = PA_1; // 測定輪エンコーダ1のA相
